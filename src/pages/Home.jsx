      ...
      <div>
        ...
        <div class="page-wrapper">
          ...
          <section class="cta-two">
            <div
              class="cta-two__bg"
              style="background-image: url(assets/images/background/footer-bg-1-1.jpg);"
            ></div>
            {/* <!-- /.cta-two__bg --> */}
            <div class="container">
              <img
          ...
          <section class="course-one__title">
            <div
              ...
              style="background-image: url(assets/images/shapes/water-wave-bg.png);"
            ></div>
            {/* <!-- /.course-one__bg --> */}
            <div class="container ">
          ...
          <section
            class="video-two"
            style="background-image: url(assets/images/shapes/video-2-bg.png);"
          >
            <img
          ...
          <section class="cta-five">
            <div
              class="cta-five__bg"
              style="background-image: url(assets/images/background/cta-5-1-bg.jpg);"
            ></div>
            {/* <!-- /.cta-five__bg --> */}
            <div class="container">
              <div
